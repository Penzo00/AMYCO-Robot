...
for i in tqdm(range(start_index, len(images_observations_df)), desc="Downloading images"):
    ...
    if text_name.endswith("series") or text_name.endswith("group") or text_name == "Homo sapiens" or any(x in text_name for x in ["sect.", "subg.", "Mixed"]) or len(text_name.split()) == 1:
        continue
